...
public class SetUpExamDAOImpl implements SetUpExamDAO {
	...
	public List<SubjectDomain> getAllSubject(ClassDomain classDomain) {
		...
		subjectList = getSession().createCriteria(SubjectDomain.class).add(Restrictions.eq("classId", classDomain.getClassId()))
				.list();
	...
	public List<StudentDomain> getAllStudent(ClassDomain classDomain) {
		...
		studentList = getSession().createCriteria(StudentDomain.class).add(Restrictions.eq("classId", classDomain.getClassId()))
				.list();
